...
static void _md5(const uint8_t* initial_msg, size_t initial_len, uint8_t* digest) {
...
void md5(const void* msg, size_t len, void* digest) {
	_md5(reinterpret_cast<const uint8_t*>(msg), len, reinterpret_cast<uint8_t*>(digest));
}